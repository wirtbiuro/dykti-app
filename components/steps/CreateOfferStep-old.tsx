...
import { submitForm, showErrorMessages, getBranchIdx, getBranchValues } from '../../utilities'
    ...
    const submit = async (e: SyntheticEvent<HTMLFormElement>) => {
        ...
        await submitForm({
            ...
            toNextSendData: {
                ...
                offerStepOfferDate: isNewBranchComparedByLastStepWhereSomethingWasChanged
                    ? DateTime.now()
