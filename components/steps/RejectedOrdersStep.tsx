...
const RejectedOrdersStep: FC<IWithOrder> = ({ order, isVisible, setIsVisible }) => {
                            ...
                            <>
                                <SendButtonsWrapper visible={false}>
                                    <NextPrevCheckbox
                                        ...
                                        isCurrentStep={prevStep?.passedTo === 'rejectedOrdersStep'}
                                    />
                                </SendButtonsWrapper>
...
export default RejectedOrdersStep
