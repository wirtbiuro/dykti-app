...
import { StepType, stepNames, stepNamesRelations, StepNames, roleTitles, getStepNames } from '../types'
...
const StepProps: FC<IStepPropsProps> = ({ step }) => {
